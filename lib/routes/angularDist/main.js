...
var UserService = /** @class */ (function () {
    ...
    UserService.prototype.getCurrentUsersName = function () {
    ...
    UserService.prototype.getUserdetails = function () {
        return this.http.get(API_URL + '/user/details').pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])(function (response) {
            ...
            var userItems;
            userItems[0] = user.displayName;
            userItems[1] = user.emails[0].value;
            userItems[2] = user.photos[0].value;
            return userItems;
        }));
    };
...
var HomeComponent = /** @class */ (function () {
    function HomeComponent(router, restaurantAPIService, route, userService) {
        ...
        this.route.params.subscribe(function (params) {
            ...
            _this.userService.getCurrentUsersName().subscribe(function (currentUserDisplayName) {
                _this.displayName = currentUserDisplayName;
...
var manageWaitlistComponent = /** @class */ (function () {
    function manageWaitlistComponent(waitlistService, restaurantAPIService, userService, route) {
        ...
        this.route.params.subscribe(function (params) {
            ...
            _this.userService.getUserdetails().subscribe(function (userItems) {
